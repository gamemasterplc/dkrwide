...
unk800E1E64 D_800E1E64_wide[59] = {
    { 0, 0, 1.0f, 53.0f, 16.0f, 0, 127, 0 },
    { 0, 3, 1.0f, 54.0f, 18.0f, 0, 0, 0 },
    { 0, 1, 0.4f, -173.0f, -68.0f, 0, 0, 0 },
    { 0, 6, 1.0f, 139.0f, 16.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 128.0f, 31.0f, 0, 0, 0 },
    { 0, 4, 1.0f, 139.0f, 32.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 149.0f, 31.0f, 0, 0, 0 },
    { 0, 8, 0.5f, 16.0f, 73.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 253.0f, 22.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 263.0f, 22.0f, 0, 0, 0 },
    { 0, 13, 1.0f, 345.0f, 16.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 312.0f, 31.0f, 0, 0, 0 },
    { 0, 7, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 22, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 5, 1.0f, -200.0f, 30.0f, 0, 0, 0 },
    { 0, 14, 1.0f, 0.0f, 0.0f, 0, 0, 0 },
    { 0, 16, 1.0f, -67.0f, 87.0f, 0, 0, 0 },
    { 0, 17, 2.0f, -67.0f, 87.0f, 0, 0, 0 },
    { 0, 18, 1.0f, 238.0f, 22.0f, 0, 0, 0 },
    { 0, 19, 1.0f, -180.0f, 88.0f, 0, 0, 0 },
    { 0, 18, 1.0f, 52.0f, 27.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 67.0f, 27.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 77.0f, 27.0f, 0, 0, 0 },
    { 0, 9, 1.0f, 327.0f, 48.0f, 0, 0, 0 },
    { 0, 6, 1.0f, 294.0f, 48.0f, 0, 0, 0 },
    { 0, 10, 1.0f, 302.0f, 48.0f, 0, 0, 0 },
    { 0, 20, 0.4f, -157.0f, -98.0f, 0, 0, 0 },
    { 0, 21, 0.5f, 16.0f, 73.0f, 0, 0, 0 },
    { 0, 23, 1.0f, 11.0f, 97.0f, 0, 0, 0 },
    { 0, 24, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 25, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 26, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 2, 1.0f, 77.0f, 48.0f, 0, 0, 0 },
    { 0, 32, 1.0f, -173.0f, 30.0f, 0, 0, 0 },
    { 0, 34, 0.4f, -157.0f, -98.0f, 0, 0, 0 },
    { 0, 35, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 36, 1.0f, 0.0f, 30.0f, 0, 0, 0 },
    { 0, 40, 1.0f, 80.0f, -60.0f, 0, 0, 0 },
    { 0, 1687158830, 0.5f, 175.0f, -71.0f, 0, 0, 0 },
    { 0, 47, 0.75f, 353.0f, 212.0f, 0, 0, 0 },
    { 0, 48, 1.0f, 340.0f, 196.0f, 0, 0, 0 },
    { 0, 49, 1.0f, 338.0f, 177.0f, 0, 0, 0 },
    { 0, 50, 1.0f, 346.0f, 159.0f, 0, 0, 0 },
    { 0, 51, 1.0f, 362.0f, 146.0f, 0, 0, 0 },
    { 0, 52, 1.0f, 381.0f, 143.0f, 0, 0, 0 },
    { 0, 53, 1.0f, 352.0f, 156.0f, 0, 0, 0 },
    { 0, 54, 0.7272f, 27.0f, 142.0f, 0, 0, 0 },
    { 0, 0, 1.0f, -200.0f, 70.0f, 0, 129, 0 },
    { 0, 3, 1.0f, -175.0f, 72.0f, 0, 0, 0 },
    { 0, 55, 1.0f, -152.0f, -89.0f, 0, 0, 0 },
    { 0, 56, 0.76f, 95.0f, 20.0f, 0, 0, 0 },
    { 0, 66, 1.0f, 92.0f, 54.0f, 0, 0, 0 },
    { 0, 8, 0.375f, -117.0f, 46.0f, 0, 0, 0 },
    { 0, 28, 1.0f, 103.0f, 56.0f, 0, 0, 0 },
    { 0, 10, 1.0f, 112.0f, 57.0f, 0, 0, 0 },
    { 0, 10, 1.0f, 121.0f, 57.0f, 0, 0, 0 },
    { 0, 67, 1.0f, -160.0f, 5.0f, 0, 0, 0 },
    { 0, 56, 1.0f, 366.0f, 16.0f, 0, 0, 0 },
    { 0, 68, 1.0f, 160.0f, 5.0f, 0, 0, 0 },
};
...
u16 D_800E25C4_wide[96] = {
    0x0000, 0x0035, 0x0010, 0x0001, 0x0036, 0x0012, 0x0004, 0x0133,
    0x0013, 0x0005, 0x013B, 0x0013, 0x0006, 0x0144, 0x0013, 0x0002,
    0xFF54, 0xFFE1, 0x001B, 0x0055, 0x0016, 0x0008, 0x013B, 0x0013,
    0x0009, 0x0144, 0x0013, 0x000B, 0x010F, 0x0013, 0x000E, 0x0000,
    0x000A, 0x0010, 0x0055, 0x0023, 0x0011, 0x0055, 0x0023, 0x0007,
    0x0055, 0x0016, 0x001C, 0x0052, 0x002A, 0x0012, 0x0130, 0x0013,
    0x000D, 0x0000, 0x000A, 0x000C, 0x0000, 0x000A, 0x0023, 0x0000, 
    0x000A, 0x0024, 0x0000, 0x000A, 0x001E, 0x0000, 0x000A, 0x001F,
    0x0000, 0x000A, 0x001D, 0x0000, 0x000A, 0x002F, 0xFF38, 0x0023,
    0x0030, 0xFF51, 0x0025, 0x0031, 0xFF62, 0xFFD3, 0x0003, 0x011C,
    0x0013, 0x0032, 0x016F, 0x0011, 0x0020, 0x015F, 0x002D, 0x0033,
    0x016B, 0x0031, 0x002E, 0x0022, 0x0047, 0xFFFF, 0xFFFF, 0xFFFF,
};
...
u16 D_800E2684_wide[118] = {
    0x0000, 0x002D, 0x0010, 0x00BB, 0x0004, 0x005E, 0x0013, 0x004E,
    0x0005, 0x0066, 0x0013, 0x0056, 0x0006, 0x006F, 0x0013, 0x005F,
    0x0002, 0xFFB7, 0xFFDC, 0x003E, 0x001B, 0x001A, 0x0016, 0xFFC9,
    0x0007, 0x001A, 0x0016, 0xFFC9, 0x0008, 0x0095, 0x0013, 0x0044,
    0x0009, 0x009E, 0x0013, 0x004D, 0x000B, 0x006B, 0x0013, 0x001A,
    0x000C, 0x0000, 0x000A, 0x0000, 0x000D, 0x0000, 0x000A, 0x0000,
    0x000E, 0xFF60, 0x000A, 0xFF60, 0x0010, 0x0066, 0x0013, 0x0056,
    0x0011, 0x0066, 0x0013, 0x0056, 0x0012, 0x008C, 0x0013, 0x003B,
    0x001C, 0x0017, 0x002A, 0xFFC6, 0x0020, 0x0012, 0x002D, 0x00AC,
    0x001E, 0xFFEA, 0x000A, 0xFFEA, 0x001F, 0x000C, 0x000A, 0x0010,
    0x001D, 0x0000, 0x000A, 0xFFD9, 0x0023, 0x0000, 0x000A, 0x0000,
    0x0024, 0x0000, 0x000A, 0x0000, 0x002F, 0xFF38, 0x0019, 0xFFD8,
    0x0030, 0xFF51, 0x001B, 0xFFF1, 0x0031, 0xFFC5, 0xFFCE, 0x004E,
    0x0003, 0x0047, 0x0013, 0x0037, 0x0033, 0x0056, 0x0014, 0x0056,
    0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0x0000, 0x0000,
};
...
void fixup_2p_battle_hud()
{
	f32 screen_w = is_widescreen() ? 424 : 320;
	D_80126CDC[50].x = screen_w-57;
	D_80126CDC[50].y = 17;
	D_80126CDC[32].x = screen_w-73;
	D_80126CDC[32].y = 45;
	D_80126CDC[51].x = screen_w-61;
	D_80126CDC[51].y = 49;
	D_80126CDC[52].x = 103;
	D_80126CDC[52].y = 49;
	D_80126CDC[53].x = screen_w-56;
	D_80126CDC[53].y = 50;
	D_80126CDC[54].x = screen_w-55;
	D_80126CDC[54].y = 51;
	D_80126CDC[55].x = screen_w-46;
	D_80126CDC[55].y = 51;
	D_80126CDC[50].y = 17;
	D_80126CDC[46].data[2] = 3;
}
...
void func_800A1428(s32 arg0, unk800A0DC0 *arg1, s32 arg2) {
    ...
    if (temp->unk1D8 == 0) {
        ...
        func_800A3CE4(arg0, arg2);
        func_800A7520(arg1, arg2);
        if ((0x7F - (arg2 * 2)) >= D_80126CDC[51].data[0]) {
            D_80126CDC[51].data[0] += (arg2 * 2);
        } else {
            D_80126CDC[51].data[0] = (D_80126CDC[51].data[0] + (arg2 * 2)) - 0xFF;
        }
        if (D_80126D37 != 2) {
...
void func_800A26C8(Object *obj, s32 arg1) {
    ...
    if (get_viewport_count() == 0) {
        ...
        if (is_in_two_player_adventure()) {
            D_80126CDC[57].image = (get_settings()->racers[1].character + 0x38);
            func_800AA600(&D_80126CFC, &D_80126D00, &D_80126D04, &D_80126CDC[57]);
        }
        func_80068508(0);
    }
}
...
void draw_ui_fix3p(s32 *arg0, s32 *arg1, s32 *arg2, unk80126CDC *arg3)
{
	f32 old_x = arg3->x;
	s32 screen_w = is_widescreen() ? 424 : 320;
	if(gNumberOfActivePlayers >= 3) {
		f32 center_x = (D_80126D08 & 0x1) ? (screen_w/4) : -(screen_w/4);
		f32 orig_center_x = (D_80126D08 & 0x1) ? 80 : -80;
		arg3->x = (arg3->x-orig_center_x)+center_x;
	}
	func_800AA600(arg0, arg1, arg2, arg3);
	arg3->x = old_x;
}
