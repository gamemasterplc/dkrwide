...
void render_textured_rectangle_stretchpos(Gfx **dlist, DrawTexture *arg1, s32 arg2, s32 arg3, u8 red, u8 green, u8 blue, u8 alpha)
{
	if(is_widescreen()) {
		arg2 = ((arg2*424.0f)/320)+0.5f;
	}
	render_textured_rectangle(dlist, arg1, arg2, arg3, red, green, blue, alpha);
}

GLOBAL_ASM("asm/non_matchings/unknown_078050/func_80078D00.s")

void render_textured_rectangle_scaled_stretchpos(Gfx **dlist, DrawTexture *element, f32 x, f32 y, f32 x_scale, f32 y_scale, u32 color, s32 flip)
{
	if(is_widescreen()) {
		x = ((x*424.0f)/320)+0.5f;
	}
	func_80078D00(dlist, element, x, y, x_scale, y_scale, color, flip);
}
