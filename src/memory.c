...
s32 check_expansion_pak() {
	return *(u32 *)0x80000318 > 0x400000;
}

/**
 * Creates the main memory pool. 
 * Starts at 0x8012D3F0. Ends at end of RAM. Contains 1600 allocation slots.
 */
...
void init_main_memory_pool(void) {
    ...
    if (1) {
        ...
        new_memory_pool(&gMainMemoryPool, ((*(u32 *)0x80000318)+0x80000000) - (s32)(&gMainMemoryPool), MAIN_POOL_SLOT_COUNT);
    }
