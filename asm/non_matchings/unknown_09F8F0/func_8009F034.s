...
lw $t6, 0x68($sp)
beqz $t6, load_ui_finish
nop
lui $v0, %hi(D_800E1E64_wide)
addiu $v0, $v0, %lo(D_800E1E64_wide)
lui $at, 0xC2BA
mtc1 $at, $f28
lui $at, 0xC230
mtc1 $at, $f24
...
beqz $t9, cont_init2p
nop
/* 09FFEC 8009F3EC 3C03800E */  lui   $v1, %hi(D_800E25C4_wide) # $v1, 0x800e
/* 09FFF0 8009F3F0 246225C4 */  addiu $v0, $v1, %lo(D_800E25C4_wide)
cont_init2p:
...
beqz $t7, load_hud34p
nop
lui $v0, %hi(D_800E2684_wide)
addiu $v0, $v0, %lo(D_800E2684_wide)
load_hud34p:
...
/* Load proper UI Offset for 3/4 Player Right Players */
lw $t7, 0x68($sp)
beqz $t7, load_34p_right_ui_texrect_ofs
addiu $t9, $t6, 160
addiu $t9, $t6, 212
load_34p_right_ui_texrect_ofs:
...
/* Load proper UI Offset for 3/4 Player Left Players */
lw $t8, 0x68($sp)
beqz $t8, load_34p_left_ui_ofs
addiu $t9, $t7, -80
addiu $t9, $t7, -106
load_34p_left_ui_ofs:
...
/* Load proper UI Offset for 3/4 Player Right Players */
lw $t7, 0x68($sp)
beqz $t7, load_34p_right_ui_ofs
addiu $t8, $t6, 80
addiu $t8, $t6, 106
load_34p_right_ui_ofs:
