...
lw $v1, 0x58($sp)
beqz $v1, finish_raceend_uiinit
nop
lui $at, 0x43E8 #464.0f
finish_raceend_uiinit:
...
.L800A6714:
lw $t7, 0x58($sp)
beqz $t7, finish_p13ui_init
nop
lui $at, 0x43C0 #384.0f
finish_p13ui_init:
...
lw $t7, 0x58($sp)
beqz $t7, finish_p24ui_init
nop
lui $at, 0x439A #308.0f
finish_p24ui_init:
...
glabel L800A691C
lw $a0, 0x58($sp)
beqz $a0, finish_levelend
addiu $s0, $0, 160
addiu $s0, $0, 212
/* Check if at least 3 players are active */
lui $a0, %hi(gNumberOfActivePlayers)
lw $a0, %lo(gNumberOfActivePlayers)($a0)
slti $a0, $a0, 3
bnez $a0, finish_levelend
nop
/* Apply altered offsets depending on whether the player is odd or even */
lh $a0, 0($a3)
andi $a0, $a0, 1
beqz $a0, finish_levelend
addiu $s0, $0, (212-26)
...
/* 0A7538 800A6938 271900A0 */  addu $t9, $t8, $s0
...
/* 0A755C 800A695C 24AA00A0 */   addu $t2, $a1, $s0
...
/* 0A75F4 800A69F4 25AE00A0 */  addu $t6, $t5, $s0
/* 0A75F8 800A69F8 448E2000 */  mtc1  $t6, $f4
/* 0A75FC 800A69FC 24AF00A0 */  addu $t7, $a1, $s0
...
/* 0A767C 800A6A7C 272A00A0 */  addu $t2, $t9, $s0
/* 0A7680 800A6A80 448A3000 */  mtc1  $t2, $f6
/* 0A7684 800A6A84 24AB00A0 */  addu $t3, $a1, $s0
...
/* 0A78D8 800A6CD8 3C01C348 */  li    $at, 0xC37C0000 # -252.000000
