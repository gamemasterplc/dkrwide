...
/* Calculate screen width based on widescreen flag */
jal is_widescreen
nop
beqz $v0, credits_start
addiu $a0, $0, 320
addiu $a0, $0, 424
credits_start:
sw $a0, 0x58($sp)
...
lw $a2, 0x58($sp)  /* Load screen width */
...
/* Calculate X Position of rotating player icons */
lw $t5, 0x58($sp)
sra $t5, $t5, 1
addu $a2, $t3, $t5
addiu $a2, $a2, -20
...
/* Calculate screen center for text stop */
lw $t6, 0x58($sp)
sra $t6, $t6, 1
...
/* 09C300 8009B700 A42F1B58 */   sh    $t6, %lo(D_800E1B50+8)($at)
.L8009B704:
