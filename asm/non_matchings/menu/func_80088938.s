...
/* Fix coordinates for controller pak text shadow */
lw $a1, 0x20($sp)
addiu $a1, $a1, 1
...
/* Fix coordinates for controller pak text */
lw $a1, 0x20($sp)
...
/* Fix coordinates for controller pak number box */
lw $a3, 0x20($sp)
addiu $a1, $a3, -102
...
/* Load accurate red box coordinates */
lw $a3, 0x20($sp)
addiu $a1, $a3, -132
...
lw $a2, 0x20($sp) /* Load down arrow x coordinate */
...
/* Fix X Position of controller pak information textbox */
lw $a3, 0x20($sp)
addiu $a1, $a3, -84
...
lw $a1, 0x20($sp) /* Fix coordinates of please wait text */
