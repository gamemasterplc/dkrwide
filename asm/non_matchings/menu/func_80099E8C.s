...
/* Setup half screen width variable */
jal is_widescreen
nop
beqz $v0, draw_ghostmenu
li $t6, 160
li $t6, 212
draw_ghostmenu:
sw $t6, 0x60($sp)
...
/* One pixel from half screen width */
lw $a1, 0x60($sp)
addiu $a1, $a1, 1
...
/* Load X Position of tiled background */
lw $t5, 0x60($sp)
addiu $t5, $t5, -120
...
/* Load X Position of tile border */
lw $a1, 0x60($sp)
addiu $a1, $a1, -120
...
/* Load X Position of Course Names */
lw $a0, 0x60($sp)
addu $a1, $a1, $a0
addiu $a1, $a1, -120
...
/* Load X Position of Player Icon */
lw $a3, 0x60($sp)
addu $a2, $a2, $a3
addiu $a2, $a2, -120
