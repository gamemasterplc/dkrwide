...
jal is_widescreen
nop
beqz $v0, draw_adventure_select
addiu $t6, $0, 160
addiu $t6, $0, 212
draw_adventure_select:
sw $t6, 0x38($sp)
...
/* Load X Position for stage name shadow */
lw $a1, 0x38($sp)
addiu $a1, $a1, 1
...
/* Load X Position of best time text */
lw $a1, 0x38($sp)
...
/* Load X Position of best lap text */
lw $a1, 0x38($sp)
/* 093CBC 800930BC 0C031110 */  jal   draw_text
addiu $a1, $a1, -72
...
/* Load X Position for filename string */
lw $a1, 0x38($sp)
addiu $a1, $a1, 98
...
/* Load X Coordinate for vehicle text */
lw $a2, 0x38($sp)
addiu $a2, $a2, -24
...
/* Load x position for highlighted vehicle names */
lw $a2, 0x38($sp)
addiu $a2, $a2, -56
...
/* Load x position for vehicle names */
lw $a2, 0x38($sp)
addiu $a2, $a2, -56
...
/* Load x position for vehicle icon */
lw $a2, 0x38($sp)
addiu $a2, $a2, -11
...
/* Load X Position for first line of adventure text */
lw $a1, 0x38($sp)
...
/* Load X Position for second line of adventure text */
lw $a1, 0x38($sp)
...
/* Load X Position for third line of adventure text */
lw $a1, 0x38($sp)
